...
class AgentSchema(BaseModel):
    ...
    AgentSchema - a model defined in OpenAPI

        namespace: The namespace of this AgentSchema.
        api_version: The api_version of this AgentSchema.
        kind: The kind of this AgentSchema.
        metadata: The metadata of this AgentSchema.
        created_at: The created_at of this AgentSchema [Optional].
        updated_at: The updated_at of this AgentSchema [Optional].
        spec: The spec of this AgentSchema.
    """
...
AgentSchema.update_forward_refs()
