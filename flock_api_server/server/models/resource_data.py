...
class ResourceData(BaseModel):
    ...
    ResourceData - a model defined in OpenAPI

        namespace: The namespace of this ResourceData.
        api_version: The api_version of this ResourceData.
        kind: The kind of this ResourceData.
        metadata: The metadata of this ResourceData.
        created_at: The created_at of this ResourceData [Optional].
        updated_at: The updated_at of this ResourceData [Optional].
        spec: The spec of this ResourceData.
    """
...
ResourceData.update_forward_refs()
